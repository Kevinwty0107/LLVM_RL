...
from config.valid_passes import VALID_PASSES
...
def make_env(seed):
    def thunk():
        ...
        env = LLVMPassEnvironment(program, VALID_PASSES)
...
if __name__ == "__main__":
    ...
    # envs setup
    envs = gym.vector.SyncVectorEnv([make_env(0)])
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts and global_step % args.train_frequency == 0:
            ...
            torch.save(q_network.state_dict(), f'/mnt/d/Cambridge/DissProjectM/llvm_rl/agents/state_dict/dqn_q')

            # update the target network
            if global_step % args.target_update_frequency == 0:
                target_network.load_state_dict(q_network.state_dict())
                torch.save(target_network.state_dict(),
                           '/mnt/d/Cambridge/DissProjectM/llvm_rl/agents/state_dict/dqn_target')
